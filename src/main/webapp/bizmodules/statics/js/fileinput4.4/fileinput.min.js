...
!function (e) {
    ...
    i = {
        ...
        dataURI2Blob: function (e) {
            var t, a, n, r, o, l, s = window.BlobBuilder || window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder, d = i.hasBlobSupport(), c = (d || s) && window.atob && window.ArrayBuffer && window.Uint8Array;
            if (!c)return null;
        ...
        constructor: t, _cleanup: function () {
            ...
            t.previewCache = {
                data: {}, init: function () {
                    ...
                    var r, o, l, s, d, c, u, p = "init_" + a, f = t.previewCache.data, m = f.config[a], v = f.content[a], h = t.previewInitId + "-" + p, g = i.ifSet("previewAsData", m, t.initialPreviewAsData), w = function (e, a, n, r, o, l, s, d, c) {
                    ...
                    a = void 0 === a ? !0 : a;
                    var o, l = r.config[e], s = i.ifSet("caption", l), d = i.ifSet("width", l, "auto"), c = i.ifSet("url", l, !1), u = i.ifSet("key", l, null), p = t.fileActionSettings, f = t.initialPreviewShowDelete || !1, m = i.ifSet("showDelete", l, i.ifSet("showDelete", p, f)), v = i.ifSet("showZoom", l, i.ifSet("showZoom", p, !0)), h = i.ifSet("showDrag", l, i.ifSet("showDrag", p, !0)), g = c === !1 && a;
            ...
            var n = this, r = n.$errorContainer, o = a || "fileuploaderror", l = t && t.id ? '<li data-file-id="' + t.id + '">' + e + "</li>" : "<li>" + e + "</li>";
            ...
            var t = this, a = t.minFileCount > 1 ? t.filePlural : t.fileSingle, n = t.msgFilesTooLess.replace("{n}", t.minFileCount).replace("{files}", a), r = t.$errorContainer;
            ...
            var r = this, o = e.trim(a + ""), l = "." === o.slice(-1) ? "" : ".", s = void 0 !== t.responseJSON && void 0 !== t.responseJSON.error ? t.responseJSON.error : t.responseText;
            ...
            var t, a = this, n = a.$container.find(".fileinput-upload"), r = !n.hasClass("disabled") && i.isEmpty(n.attr("disabled"));
            ...
            var t = this, a = t.$preview, n = t.showUploadedThumbs ? t.getFrames(":not(.file-preview-success)") : t.getFrames();
            n.each(function () {
                var t = e(this);
            ...
            var i = this, t = i.previewZoomButtonIcons[e], a = i.previewZoomButtonClasses[e], n = ' title="' + (i.previewZoomButtonTitles[e] || "") + '" ', r = n + ("close" === e ? ' data-dismiss="modal" aria-hidden="true"' : "");
            ...
            var i, t, a = this, n = a.$modal.data("previewId") || "", r = a.getFrames().toArray(), o = r.length, l = a.$modal.find(".btn-prev"), s = a.$modal.find(".btn-next");
            ...
            var i = this, t = i.$modal, a = t.find(".modal-header:visible"), n = t.find(".modal-footer:visible"), r = t.find(".modal-body"), o = e(window).height(), l = 0;
            ...
            if (a.hasClass("file-zoom-fullscreen"))i.toggleFullScreen(!1), e ? n.hasClass("active") || (a.removeClass("file-zoom-fullscreen"), t._resizeZoomDialog(!0), r.hasClass("active") && r.removeClass("active").attr("aria-pressed", "false")) : n.hasClass("active") ? n.removeClass("active").attr("aria-pressed", "false") : (a.removeClass("file-zoom-fullscreen"),
            ...
            var n, r, o, l, s, d, c, u, p, f, m = this, v = t.attr("id"), h = m.$modal, g = h.find(".btn-prev"), w = h.find(".btn-next"), _ = h.find(".btn-fullscreen"), b = h.find(".btn-borderless"), C = h.find(".btn-toggleheader"), y = m.$preview.find("#zoom-" + v);
            ...
            T.length && i.adjustOrientedImage(T, !0), m._handler(g, "click", function () {
                ...
                var e, i = h.find(".modal-header"), t = h.find(".modal-body .floating-buttons"), a = i.find(".kv-zoom-actions"), n = function (e) {
            ...
            var a, n, r, o = this, l = o.$modal.find(".kv-zoom-actions .btn-" + i), s = o.getFrames().toArray(), d = s.length;
            if (!l.attr("disabled")) {
            ...
            var r, o, l, s, d, c, u, p, f, m, v = this, h = v.getFileStack().length, g = new FormData, w = v.previewInitId + "-" + t, _ = v.filestack.length > 0 || !e.isEmptyObject(v.uploadExtraData), b = e("#" + w).find(".file-thumb-progress"), C = {
                id: w,
                index: t
            };
            ...
            var t, a, n, r, o, l = this, s = l.filestack, d = s.length, c = {}, u = l.filestack.length > 0 || !e.isEmptyObject(l.uploadExtraData);
            l.formdata = new FormData, 0 !== d && u && !l._abort(c) && (o = function () {
                ...
                var r = l._getOutData(n, t), s = l._getThumbs(":not(.file-preview-error)"), d = 0, c = i.isEmpty(t) || i.isEmpty(t.errorkeys) ? [] : t.errorkeys;
            ...
            t.showPreview && (t._initZoomButton(), t.getFrames(" .kv-file-remove").each(function () {
                ...
                t._handler(s, "click", function () {
                    return l = t._raise("filepreremove", [c, u]), l !== !1 && t._validateMinCount() ? (n = d.hasClass("file-preview-error"), i.cleanMemory(d), void d.fadeOut("slow", function () {
                        ...
                        var l = t.getFileStack(!0), s = t.previewCache.count(), p = l.length, f = t.showPreview && t.getFrames().length;
            ...
            var t = this, a = t.$preview, n = t.deleteExtraData || {}, r = i.FRAMES + " .kv-file-remove", o = function () {
            ...
            var f, m = this, v = m.slug(n), h = "", g = m.previewSettings[t] || m.defaults.previewSettings[t], w = g && g.width ? g.width : "", _ = g && g.height ? g.height : "", b = c || m._renderFileFooter(v, s, i.isEmpty(w) ? "auto" : w, l), C = m._getPreviewIcon(n), y = "type-default", T = C && m.preferIconicPreview, E = C && m.preferIconicZoomPreview, x = function (a, l, s, c) {
            ...
            if (r.showPreview) {
                var l, s = t ? t.name : "", d = t ? t.type : "", c = t.size || 0, u = r.slug(s), p = n === !0 && !r.isUploadable, f = i.objUrl.createObjectURL(t);
            ...
            if (this.showPreview) {
                var o, l = this, s = l._parseFileType(t), d = t ? t.name : "", c = l.slug(d), u = l.allowedPreviewTypes, p = l.allowedPreviewMimeTypes, f = l.$preview, m = u && u.indexOf(s) >= 0, v = t.size || 0, h = t.type, g = "text" === s || "html" === s || "image" === s ? a.target.result : r, w = p && -1 !== p.indexOf(h);
            ...
            n.loadedImages = [], n.totalImagesCount = 0, e.each(t, function (e, i) {
                ...
                var T, E, x, F, S, I, k, P, z, A, $ = v + e, D = p + "-" + $, U = t[e], j = U.name ? n.slug(U.name) : "", B = (U.size || 0) / 1e3, L = "", O = i.objUrl.createObjectURL(U), R = 0, M = "";
                if (g > 0)for (F = 0; g > F; F++)P = h[F], z = n.msgFileTypes[P] || P, M += 0 === F ? z : ", " + z;
            ...
            var t = this, a = t.$element, n = t.getFileStack(), r = i.isIE(9) && i.findFileName(a.val()) || a[0].files[0] && a[0].files[0].name || n.length && n[0].name || "", o = t.slug(r), l = t.isUploadable ? n.length : e, s = t.previewCache.count() + l, d = l > 1 ? t._getMsgSelected(s) : o;
            ...
            var t = this;
            if (t.showPreview) {
                var a = "indicator" + i, n = a + "Title", r = "file-preview-" + i.toLowerCase(), o = e.find(".file-upload-indicator"), l = t.fileActionSettings;
            ...
            var o, l, s, d, c = this, u = c.$preview, p = u.find("#" + i), f = p.attr("data-fileindex"), m = p.find("img");
            t = t || "Untitled", m.one("load", function () {
                l = p.width(), s = u.width(), l > s && (m.css("width", "100%"), p.css("width", "97%")), o = {
                    ind: f,
                    id: i
                ...
                this.complete ? e(this).load() : this.error && e(this).error()
            })
            ...
            var r, o, l, s, d, c, u, p = this, f = e(t.img)[0], m = f.naturalWidth, v = f.naturalHeight, h = 1, g = p.maxImageWidth || m, w = p.maxImageHeight || v, _ = !(!m || !v), b = p.imageCanvas, C = p.imageCanvasContext, y = t.typ, T = t.pid, E = t.ind, x = t.thumb, F = t.exifObj;
            if (d = function (e, i, t) {
            ...
            var e = this, i = e.isUploadable && e.dropZoneEnabled ? " file-drop-zone" : "file-drop-disabled", t = e.showClose ? e._getLayoutTemplate("close") : "", a = e.showPreview ? e._getLayoutTemplate("preview").setTokens({
                "class": e.previewClass,
                dropClass: i
            }) : "", n = e.isDisabled ? e.captionClass + " file-caption-disabled" : e.captionClass, r = e.captionTemplate.setTokens({"class": n + " kv-fileinput-caption"});
            ...
            var t = this, a = t._getLayoutTemplate("btnDefault"), n = t[e + "Class"], r = t[e + "Title"], o = t[e + "Icon"], l = t[e + "Label"], s = t.isDisabled ? " disabled" : "", d = "button";
            switch (e) {
                case"remove":
            ...
            var r, o = this, l = o.fileActionSettings, s = l.showRemove, d = l.showDrag, c = l.showUpload, u = l.showZoom, p = o._getLayoutTemplate("footer"), f = n ? l.indicatorError : l.indicatorNew, m = o._getLayoutTemplate("indicator"), v = n ? l.indicatorErrorTitle : l.indicatorNewTitle, h = m.setTokens({
                indicator: f,
                indicatorTitle: v
            });
            ...
            if (!(e || i || t || a))return "";
            var s, d = this, c = r === !1 ? "" : ' data-url="' + r + '"', u = o === !1 ? "" : ' data-key="' + o + '"', p = "", f = "", m = "", v = "", h = d._getLayoutTemplate("actions"), g = d.fileActionSettings, w = d.otherActionButtons.setTokens({dataKey: u}), _ = n ? g.removeClass + " disabled" : g.removeClass;
            ...
            var r, o, l, s, d = [], c = arguments.length > 1, u = a.isUploadable, p = c ? t.originalEvent.dataTransfer.files : n.get(0).files, f = a.filestack.length, m = i.isEmpty(n.attr("multiple")), v = m && f > 0, h = 0, g = a._getFileIds(), w = function (i, t, n, r) {
                var o = e.extend(!0, {}, a._getOutData({}, {}, p), {id: n, index: r}), l = {
                    id: n,
                    index: r,
                    file: t,
                    files: p
        ...
        if (i.hasFileAPISupport() || i.isIE(9)) {
            ...
            switch (n.shift(), this.each(function () {
                var o, l = e(this), s = l.data("fileinput"), d = "object" == typeof a && a, c = d.theme || l.data("theme"), u = {}, p = {}, f = d.language || l.data("language") || e.fn.fileinput.defaults.language || "en";
